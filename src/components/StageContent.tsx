    ...
    <div className="max-w-6xl mx-auto p-4 lg:p-6">
      ...
      <div className="relative mb-4">
        ...
        <button
          ...
          className={`hidden lg:block absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 lg:-translate-x-8 z-10 w-auto p-3 rounded-full border transition-colors ${
            currentStage === 0
